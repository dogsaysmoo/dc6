...
# 4 Turn Anticipation for LNAV/FMS navigation
# (as in 747-8i)
var turn_anticipation = func {
        if (getprop("autopilot/route-manager/active")) {
                ...
                max_wpt-=1;
                var eta = 9999;
		if (getprop("velocities/groundspeed-kt") > 10 and atm_wpt != 0)
		    eta = (getprop("/autopilot/route-manager/wp/dist") / getprop("/velocities/groundspeed-kt")) * 3600;
                if (eta <= 20 and getprop("/autopilot/route-manager/wp/dist")<20){
